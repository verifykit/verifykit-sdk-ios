...
- (nonnull instancetype)initWithEnvironment:(enum VerifyKitEnvironment)environment logActive:(BOOL)logActive deviceID:(NSString * _Nullable)deviceID countryCode:(NSString * _Nullable)countryCode phoneCode:(NSString * _Nullable)phoneCode phoneNumber:(NSString * _Nullable)phoneNumber sessionToken:(NSString * _Nullable)sessionToken OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
